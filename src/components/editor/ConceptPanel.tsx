...
export function ConceptPanel({ onApplyConcept, onOpenInstallFocus }: ConceptPanelProps) {
  ...
  return (
    <div className="w-80 flex-shrink-0 bg-zinc-900 border-l border-zinc-700 flex flex-col">
      {/* Header */}
      ...
      {/* Footer */}
      <div className="p-3 border-t border-zinc-700 bg-zinc-800/50 space-y-2">
        {onOpenInstallFocus && (
          <button
