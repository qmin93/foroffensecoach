...
export const FORMATION_PRESETS: Record<string, { name: string; players: Array<{ role: string; label: string; x: number; y: number }> }> = {
  iFormation: {
    name: 'I Formation',
    players: [
      // O-Line: tight spacing (gap of 0.05), below LOS (y: -0.02)
      { role: 'C', label: 'C', x: 0.5, y: -0.02 },
      { role: 'LG', label: 'LG', x: 0.45, y: -0.02 },
      { role: 'RG', label: 'RG', x: 0.55, y: -0.02 },
      { role: 'LT', label: 'LT', x: 0.40, y: -0.02 },
      { role: 'RT', label: 'RT', x: 0.60, y: -0.02 },
      { role: 'TE', label: 'TE', x: 0.35, y: -0.02 },
      { role: 'WR', label: 'X', x: 0.1, y: -0.02 },
      // Backfield (under center)
      { role: 'QB', label: 'QB', x: 0.5, y: -0.06 },
      { role: 'FB', label: 'FB', x: 0.5, y: -0.12 },
      { role: 'RB', label: 'RB', x: 0.5, y: -0.18 },
      { role: 'WR', label: 'Z', x: 0.9, y: -0.02 },
    ],
  },
  shotgun: {
    name: 'Shotgun',
    players: [
      ...
      { role: 'LT', label: 'LT', x: 0.40, y: -0.02 },
      { role: 'RT', label: 'RT', x: 0.60, y: -0.02 },
      { role: 'TE', label: 'TE', x: 0.65, y: -0.02 },
      { role: 'WR', label: 'X', x: 0.1, y: -0.02 },
      { role: 'WR', label: 'H', x: 0.2, y: -0.02 },
      { role: 'QB', label: 'QB', x: 0.5, y: -0.14 },
      { role: 'RB', label: 'RB', x: 0.42, y: -0.14 },
      { role: 'WR', label: 'Z', x: 0.9, y: -0.02 },
    ],
  },
  spread: {
    ...
    players: [
      ...
      { role: 'LT', label: 'LT', x: 0.40, y: -0.02 },
      { role: 'RT', label: 'RT', x: 0.60, y: -0.02 },
      { role: 'WR', label: 'X', x: 0.05, y: -0.02 },
      { role: 'WR', label: 'H', x: 0.15, y: -0.02 },
      { role: 'QB', label: 'QB', x: 0.5, y: -0.14 },
      { role: 'RB', label: 'RB', x: 0.58, y: -0.14 },
      { role: 'WR', label: 'Y', x: 0.85, y: -0.02 },
      { role: 'WR', label: 'Z', x: 0.95, y: -0.02 },
    ],
  },
  singleBack: {
    name: 'Single Back',
    players: [
      ...
      { role: 'LT', label: 'LT', x: 0.40, y: -0.02 },
      { role: 'RT', label: 'RT', x: 0.60, y: -0.02 },
      { role: 'TE', label: 'Y', x: 0.35, y: -0.02 },
      { role: 'WR', label: 'X', x: 0.1, y: -0.02 },
      { role: 'QB', label: 'QB', x: 0.5, y: -0.06 },
      { role: 'RB', label: 'RB', x: 0.5, y: -0.14 },
      { role: 'WR', label: 'H', x: 0.65, y: -0.02 },
      { role: 'WR', label: 'Z', x: 0.9, y: -0.02 },
    ],
  },
  proSet: {
    ...
    players: [
      ...
      { role: 'WR', label: 'X', x: 0.1, y: -0.02 },
      { role: 'QB', label: 'QB', x: 0.5, y: -0.06 },
      { role: 'RB', label: 'RB', x: 0.42, y: -0.12 },
      { role: 'FB', label: 'FB', x: 0.58, y: -0.12 },
      { role: 'WR', label: 'Z', x: 0.9, y: -0.02 },
    ],
  },
  emptySet: {
    ...
    players: [
      ...
      { role: 'WR', label: 'H', x: 0.2, y: -0.02 },
      { role: 'QB', label: 'QB', x: 0.5, y: -0.14 },
      { role: 'TE', label: 'Y', x: 0.65, y: -0.02 },
      { role: 'WR', label: 'F', x: 0.85, y: -0.02 },
      { role: 'WR', label: 'Z', x: 0.95, y: -0.02 },
    ],
  },
};
