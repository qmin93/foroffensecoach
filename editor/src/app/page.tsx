      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Build Your Playbook
            <span className="block text-green-600">In Minutes</span>
          </h1>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Feature 2 */}
            <div className="p-6 rounded-xl bg-card border border-border">
              <div className="w-12 h-12 rounded-lg bg-primary/20 flex items-center justify-center text-2xl mb-4">
                💡
              </div>
            ...
            {/* Feature 5 */}
            <div className="p-6 rounded-xl bg-card border border-border">
              <div className="w-12 h-12 rounded-lg bg-destructive/20 flex items-center justify-center text-2xl mb-4">
                🔗
              </div>
